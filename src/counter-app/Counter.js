...
import '../counter-app/counter.css';
 const Counter = () => {
  ...
  return (
    <div className='container-fluid' >
       ...
       <button label='button' onClick={()=>{setcount(count-1);switchvalue('decrease')}} style={{background:'lightblue',borderRadius:'4px', width:'10rem', marginRight:'5px'}}>Decrease</button>
       <button label='button' onClick={()=>setcount(0)} style={{background:'blue',borderRadius:'4px', width:'10rem'}}>Reset</button>
       </div>
       </div>
    </div>
  )
